...
BUBBLE_SMALLER_BY = 1
NO_BUBBLE = "EMPTY"
SPACE_BETWEEN_COLS = 7
ROWS_OVERLAP = 1
WINDOW_HEIGHT = 750
WINDOW_WIDTH = BUBBLE_GRID_COLS * (
        BUBBLE_RADIUS * 2 + SPACE_BETWEEN_COLS) + BUBBLE_RADIUS * 2
...
SCORE_LOCATION = (WINDOW_WIDTH-150, WINDOW_HEIGHT - TURNS_FONT_SIZE - 10)
MAX_SCORE_TEXT = "Max score: "
MAX_SCORE_LOCATION = (WINDOW_WIDTH-150, WINDOW_HEIGHT - TURNS_FONT_SIZE - 40)

BUBBLE_IMG1 = pygame.image.load("1.png")
BUBBLE_IMG2 = pygame.image.load("2.png")
BUBBLE_IMG3 = pygame.image.load("3.png")
