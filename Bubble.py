...
def should_stop(bubbles_grid, bullet_bubble):
    ...
    # OR HIT THE CEILING
    if bullet_bubble["center_y"] == 0 + consts.BUBBLE_RADIUS:
        return True
    return False


def distance_between_two_bubbles(bubble, bullet_bubble):
    # get center values
    x1 = bubble["center_x"]
    x2 = bullet_bubble["center_x"]

    y1 = bubble["center_y"]
    y2 = bullet_bubble["center_y"]
